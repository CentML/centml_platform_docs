...
CentML provides enterprise support for the NVIDIA CCluster and a ticket system where you can submit a support ticket directly via the NVIDIA CCluster's user interface.
...
To submit a request ticket from the NVIDIA CCluster UI, you must have an active CentML account. If you don't, please follow the [Creating an Account](/resources/account_creation) doucmentation before submitting a request. If you cannot create an account, please contact `support@centml.ai`.
