...
<Note>
Endpoint bearer tokens (from your [Vault](/resources/vault)) are not the same as [service account](/resources/service_accounts) credentials. Service accounts authenticate automation to NVIDIA CCluster platform APIs; Vault bearer tokens protect calls to your deployed endpoints.
</Note>
