...
The SDK can also list, create, and delete the **hardware instances** available to a cluster. See [Managing Hardware Instances](/resources/hardware_instances) for details.
