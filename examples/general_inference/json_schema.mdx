---
title: 'Json Schema'
description: 'Support for json schema enforced responses'
icon: 'code-simple'
---
...
This example is tailored for testing with an NVIDIA CCluster hosted LLM endpoint, using environment variables for configuration.
...
2. **OpenAI API Interaction:**
     - The script interacts with the NVIDIA CCluster hosted OpenAI-compatible API to generate JSON profiles.
