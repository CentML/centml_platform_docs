---
title: 'FLUX'
description: 'Deploy your own FLUX Image Generation endpoint using NVIDIA CCluster and an example from Codex'
icon: 'images'
---
...
1. Log in to NVIDIA CCluster
Access the NVIDIA CCluster dashboard using the console URL provided to your organization.
