---
title: 'bash'
description: 'Build your own chatbot using CentML CCluster and an example from Codex'
icon: 'terminal'
---
<Frame>
...
This Bash script interacts with the LLaMA model via CentML’s LLM API to create a simple real-time chat interface. The assistant provides helpful responses to user inputs, allowing you to have a back-and-forth conversation.
