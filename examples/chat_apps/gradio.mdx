...
This Gradio-based web app allows you to interact with the CentML LLM API. It streams the assistant's responses in real-time, providing a conversational interface where users can chat with an AI assistant.
