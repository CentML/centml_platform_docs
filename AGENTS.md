...
- The docs site is configured by [docs.json](/Users/anurlybayev/Developer/codex/centml_platform_docs/docs.json).
...
- The Dockerfile installs the latest Mintlify CLI with `mint@latest`.
...
- Direct local CLI is acceptable:
...
- Treat [docs.json](/Users/anurlybayev/Developer/codex/centml_platform_docs/docs.json) as the source of truth for page order and visibility.
...
- The current [README.md](/Users/anurlybayev/Developer/codex/centml_platform_docs/README.md) is repo-specific and should stay aligned with the repository’s Mintlify workflow.
...
1. Read [README.md](/Users/anurlybayev/Developer/codex/centml_platform_docs/README.md) and [docs.json](/Users/anurlybayev/Developer/codex/centml_platform_docs/docs.json).
