...
To interact with CentML endpoints programmatically, you need a Bearer Token. Follow the [Managing Vault Objects](/resources/vault) documentation to generate one.
