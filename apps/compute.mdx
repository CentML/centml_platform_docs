...
- **Endpoint URL** — the hostname for your instance. Next to it are the copy button (copies the URL) and the SSH button (copies `root@<endpoint_url>` so you can paste it directly into your terminal).
